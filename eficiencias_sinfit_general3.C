...
#include <math.h>
	...
	void eficiencias_sinfit_general3()
	{
	...
	double efi, efi1, efi2, efi3, efi4, knee;
 	...
 	double parameters[3];
  	...
  	rollsend>>rollName;
	efi_end.open("eficiencias/eficiencias_endcap3.txt");
  		...
  		while (!rollsend.eof() ) 
		{
			...
			knee= wp-0.120;
				...
				efi=amano(knee+0.280,parameters[1],parameters[0],parameters[2]);
				efi1=amano(knee+0.300,parameters[1],parameters[0],parameters[2]);
				efi2=amano(knee+0.320,parameters[1],parameters[0],parameters[2]);
				efi3=amano(knee+0.340,parameters[1],parameters[0],parameters[2]);
				efi4=amano(knee+0.360,parameters[1],parameters[0],parameters[2]);
	...
	rollsend.close();
  	...
  	rollsbar>>rollName;
	efi_bar.open("eficiencias/eficiencias_barrel3.txt");
	...
	rollsre4.open("data_filtered/re4_filtered.txt");
  	rollsre4>>rollName;
	efi_re4.open("eficiencias/eficiencias_re43.txt");
