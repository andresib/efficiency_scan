...
//	setTDRStyle();
	...
	barrel.open("eficiencias_barrel0.txt");
  	endcap.open("eficiencias_endcap0.txt");
  	re4.open("eficiencias_re40.txt");
	...
	// Histos
	TH1F* efiBAR = new TH1F("Efficiency knee",  "Barrel Efficiency", 30, 55, 115);
	TH1F* efi1BAR = new TH1F("Efficiency knee+20V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi2BAR = new TH1F("Efficiency knee+40V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi3BAR = new TH1F("Efficiency knee+60V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi4BAR = new TH1F("Efficiency knee+80V", "Barrel Efficiency", 30, 55, 115);

	TH1F* efiEND = new TH1F("Efficiency knee",  "Endcap Efficiency", 30, 55, 115);
	TH1F* efi1END = new TH1F("Efficiency knee+20V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi2END = new TH1F("Efficiency knee+40V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi3END = new TH1F("Efficiency knee+60V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi4END = new TH1F("Efficiency knee+80V", "Endcap Efficiency", 30, 55, 115);

	TH1F* efiRE4 = new TH1F("Efficiency knee",  "RE4 Efficiency", 30, 55, 115);
	TH1F* efi1RE4 = new TH1F("Efficiency knee+20V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi2RE4 = new TH1F("Efficiency knee+40V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi3RE4 = new TH1F("Efficiency knee+60V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi4RE4 = new TH1F("Efficiency knee+80V", "RE4 Efficiency", 30, 55, 115);
	...
	MyCanvas->SaveAs("histogramas_0/knee0.png");
	...
	//Pad1->SetLogy();
	MyCanvas->SaveAs("histogramas_0/effbarrel0.png");
	...
	MyCanvas->SaveAs("histogramas_0/effendcap0.png");
	...
	MyCanvas->SaveAs("histogramas_0/effRE40.png");
	//MyCanvas->SetLogy();
