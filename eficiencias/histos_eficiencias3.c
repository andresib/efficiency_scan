...
//	setTDRStyle();
	...
	barrel.open("eficiencias_barrel3.txt");
  	endcap.open("eficiencias_endcap3.txt");
  	re4.open("eficiencias_re43.txt");
	...
	// Histos
	TH1F* efiBAR = new TH1F("Efficiency knee+280V",  "Barrel Efficiency", 30, 55, 115);
	TH1F* efi1BAR = new TH1F("Efficiency knee+300V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi2BAR = new TH1F("Efficiency knee+320V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi3BAR = new TH1F("Efficiency knee+340V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi4BAR = new TH1F("Efficiency knee+360V", "Barrel Efficiency", 30, 55, 115);

	TH1F* efiEND = new TH1F("Efficiency knee+280V",  "Endcap Efficiency", 30, 55, 115);
	TH1F* efi1END = new TH1F("Efficiency knee+300V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi2END = new TH1F("Efficiency knee+320V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi3END = new TH1F("Efficiency knee+340V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi4END = new TH1F("Efficiency knee+360V", "Endcap Efficiency", 30, 55, 115);

	TH1F* efiRE4 = new TH1F("Efficiency knee+280V",  "RE4 Efficiency", 30, 55, 115);
	TH1F* efi1RE4 = new TH1F("Efficiency knee+300V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi2RE4 = new TH1F("Efficiency knee+320V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi3RE4 = new TH1F("Efficiency knee+340V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi4RE4 = new TH1F("Efficiency knee+360V", "RE4 Efficiency", 30, 55, 115);
	...
	MyCanvas->SaveAs("histogramas_3/knee3.png");
	...
	//Pad1->SetLogy();
	MyCanvas->SaveAs("histogramas_3/effbarrel3.png");
	...
	MyCanvas->SaveAs("histogramas_3/effendcap3.png");
	...
	MyCanvas->SaveAs("histogramas_3/effRE43.png");
	//MyCanvas->SetLogy();
