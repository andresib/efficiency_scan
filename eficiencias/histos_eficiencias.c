...
//	setTDRStyle();
	...
	barrel.open("eficiencias_barrel.txt");
  	endcap.open("eficiencias_endcap.txt");
  	re4.open("eficiencias_re4.txt");
	...
	// Histos
	TH1F* efiBAR = new TH1F("Efficiency knee+80V",  "Barrel Efficiency", 30, 55, 115);
	TH1F* efi1BAR = new TH1F("Efficiency knee+100V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi2BAR = new TH1F("Efficiency knee+120V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi3BAR = new TH1F("Efficiency knee+140V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi4BAR = new TH1F("Efficiency knee+160V", "Barrel Efficiency", 30, 55, 115);

	TH1F* efiEND = new TH1F("Efficiency knee+80V",  "Endcap Efficiency", 30, 55, 115);
	TH1F* efi1END = new TH1F("Efficiency knee+100V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi2END = new TH1F("Efficiency knee+120V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi3END = new TH1F("Efficiency knee+140V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi4END = new TH1F("Efficiency knee+160V", "Endcap Efficiency", 30, 55, 115);

	TH1F* efiRE4 = new TH1F("Efficiency knee+80V",  "RE4 Efficiency", 30, 55, 115);
	TH1F* efi1RE4 = new TH1F("Efficiency knee+100V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi2RE4 = new TH1F("Efficiency knee+120V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi3RE4 = new TH1F("Efficiency knee+140V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi4RE4 = new TH1F("Efficiency knee+160V", "RE4 Efficiency", 30, 55, 115);
	...
	MyCanvas->SaveAs("histogramas/knee.png");
	...
	//Pad1->SetLogy();
	MyCanvas->SaveAs("histogramas/effbarrel.png");
	...
	MyCanvas->SaveAs("histogramas/effendcap.png");
	...
	MyCanvas->SaveAs("histogramas/effRE4.png");
	//MyCanvas->SetLogy();
