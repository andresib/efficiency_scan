...
//	setTDRStyle();
	...
	barrel.open("eficiencias_barrel4.txt");
  	endcap.open("eficiencias_endcap4.txt");
  	re4.open("eficiencias_re44.txt");
	...
	// Histos
	TH1F* efiBAR = new TH1F("Efficiency knee+380V",  "Barrel Efficiency", 30, 55, 115);
	TH1F* efi1BAR = new TH1F("Efficiency knee+400V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi2BAR = new TH1F("Efficiency knee+420V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi3BAR = new TH1F("Efficiency knee+440V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi4BAR = new TH1F("Efficiency knee+460V", "Barrel Efficiency", 30, 55, 115);

	TH1F* efiEND = new TH1F("Efficiency knee+380V",  "Endcap Efficiency", 30, 55, 115);
	TH1F* efi1END = new TH1F("Efficiency knee+400V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi2END = new TH1F("Efficiency knee+420V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi3END = new TH1F("Efficiency knee+440V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi4END = new TH1F("Efficiency knee+460V", "Endcap Efficiency", 30, 55, 115);

	TH1F* efiRE4 = new TH1F("Efficiency knee+380V",  "RE4 Efficiency", 30, 55, 115);
	TH1F* efi1RE4 = new TH1F("Efficiency knee+400V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi2RE4 = new TH1F("Efficiency knee+420V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi3RE4 = new TH1F("Efficiency knee+440V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi4RE4 = new TH1F("Efficiency knee+460V", "RE4 Efficiency", 30, 55, 115);
	...
	MyCanvas->SaveAs("histogramas_4/knee4.png");
	...
	//Pad1->SetLogy();
	MyCanvas->SaveAs("histogramas_4/effbarrel4.png");
	...
	MyCanvas->SaveAs("histogramas_4/effendcap4.png");
	...
	MyCanvas->SaveAs("histogramas_4/effRE44.png");
	//MyCanvas->SetLogy();
