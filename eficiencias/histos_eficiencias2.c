...
//	setTDRStyle();
	...
	barrel.open("eficiencias_barrel2.txt");
  	endcap.open("eficiencias_endcap2.txt");
  	re4.open("eficiencias_re42.txt");
	...
	// Histos
	TH1F* efiBAR = new TH1F("Efficiency knee+180V",  "Barrel Efficiency", 30, 55, 115);
	TH1F* efi1BAR = new TH1F("Efficiency knee+200V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi2BAR = new TH1F("Efficiency knee+220V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi3BAR = new TH1F("Efficiency knee+240V", "Barrel Efficiency", 30, 55, 115);
	TH1F* efi4BAR = new TH1F("Efficiency knee+260V", "Barrel Efficiency", 30, 55, 115);

	TH1F* efiEND = new TH1F("Efficiency knee+180V",  "Endcap Efficiency", 30, 55, 115);
	TH1F* efi1END = new TH1F("Efficiency knee+200V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi2END = new TH1F("Efficiency knee+220V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi3END = new TH1F("Efficiency knee+240V", "Endcap Efficiency", 30, 55, 115);
	TH1F* efi4END = new TH1F("Efficiency knee+260V", "Endcap Efficiency", 30, 55, 115);

	TH1F* efiRE4 = new TH1F("Efficiency knee+180V",  "RE4 Efficiency", 30, 55, 115);
	TH1F* efi1RE4 = new TH1F("Efficiency knee+200V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi2RE4 = new TH1F("Efficiency knee+220V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi3RE4 = new TH1F("Efficiency knee+240V", "RE4 Efficiency", 30, 55, 115);
	TH1F* efi4RE4 = new TH1F("Efficiency knee+260V", "RE4 Efficiency", 30, 55, 115);
	...
	MyCanvas->SaveAs("histogramas_2/knee2.png");
	...
	//Pad1->SetLogy();
	MyCanvas->SaveAs("histogramas_2/effbarrel2.png");
	...
	MyCanvas->SaveAs("histogramas_2/effendcap2.png");
	...
	MyCanvas->SaveAs("histogramas_2/effRE42.png");
	//MyCanvas->SetLogy();
